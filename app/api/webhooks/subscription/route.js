...
async function syncSubscription(supabase, stripe, subscription) {
  ...
  // billing periods since API version 2025-03-31). Fall back to the
  // top-level field for older API versions, and to trial_end so a
  // trialing subscription still gets a real date even if the item-level
