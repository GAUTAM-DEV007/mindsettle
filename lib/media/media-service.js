...
export async function createMediaRecord({
  ...
  const mediaRecord = {
    ...
    // supplies the actual media duration.
    duration_minutes: 1,

    /*
     * If a separate thumbnail was uploaded,
     * use that path.
     *
     * For a standalone image upload,
     * the image itself can act as its thumbnail.
     */
    thumbnail_url:
      thumbnailPath ||
      (isImage ? storagePath : null),

    /*
     * Video and audio currently use video_url
     * as their main media-storage path.
     */
    video_url:
      isImage ? null : storagePath,
